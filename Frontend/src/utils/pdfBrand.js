...
// Shared SecKnight Vision brand palette for all report PDFs.
...
// Rasterize the SecKnight Vision logo asset to a PNG data URL via an off-DOM
...
export const drawFooter = (doc, { margin, pageWidth }) => {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.setTextColor(...PDF_BRAND.subtle);
    doc.text(
      "SecKnight Vision • Your Workforce Productivity Compass",
      margin,
      ph - 12
    );
