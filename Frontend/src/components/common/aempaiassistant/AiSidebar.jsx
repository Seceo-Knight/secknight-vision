      ...
      <div className={`shrink-0 ${collapsed ? "py-4 px-0" : "px-3 py-4"}`}>
        {collapsed ? (
          <div className="flex flex-col items-center gap-1">
            <img src={aiLogo} alt="SECKNIGHT AI" className="w-8 h-8 object-contain" />
            <button
          ...
          <div className="flex items-center gap-2">
            <img src={aiLogo} alt="SECKNIGHT AI" className="w-8 h-8 object-contain shrink-0" />
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-slate-800 truncate leading-tight">SECKNIGHT AI ASSISTANT</p>
