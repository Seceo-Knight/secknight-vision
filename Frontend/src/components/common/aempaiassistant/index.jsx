...
const LoaderScreen = () => (
  <div className="flex-1 flex flex-col items-center justify-center gap-4">
    <img src={aiLogo} alt="SECKNIGHT AI" className="w-20 h-20 object-contain" />
    <div className="text-center">
      <h2 className="text-lg font-bold text-slate-800 tracking-wide">SECKNIGHT AI ASSISTANT</h2>
  ...
  return (
    <>
      ...
      >
        ...
        <img src={aiLogo} alt="SECKNIGHT AI" className="w-10 h-10 object-contain pointer-events-none" />
      </div>
    </>
  );
};
